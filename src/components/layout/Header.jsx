...
export default function Header() {
  ...
  /*
   * Route changed:
   * always reset mobile navigation.
   */
  useEffect(() => {
    setMobileOpen(false);
   ...
   *
   * That combination causes Safari problems when
   * the fixed mobile menu is opened after scrolling.
   */
  useEffect(() => {
    if (!mobileOpen) {
      return undefined;
            ...
            <div className="vineco-desktop-product">
              ...
              <NavLink
                ...
                className={({
                  ...
                  [
                    "vineco-desktop-product__trigger",
                    isActive
                      ? "active"
                      : "",
                  ].join(" ")
